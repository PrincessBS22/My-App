...
import walleIcon from "../assets/Wall-E-icon.png";

const BotFwiend = ({ isVisible, onClose }) => {
  ...
  return (
    <div className={styles["chatbot-container"]}>
      <div className={styles["chatbot-header"]}>
        <h3>Chatbot</h3>
        <img src={walleIcon} className={styles["chatbot-icon"]} />
        <p>Alfred</p>
