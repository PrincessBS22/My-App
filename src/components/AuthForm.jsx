...
const AuthForm = ({isRegister} = false) => {
    ...
    const {data, error, submited, successM, handleChange, handleSubmit} = useAuthForm(isRegister);
    ...
    //     try{
    //         const response = await fetch("https://web.ics.purdue.edu/~shaverb/auth.php",{
    //             method: "POST",
    //             body: formData,
    //         });
