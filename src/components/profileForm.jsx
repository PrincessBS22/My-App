...
import useProfHook from "../hooks/profileFormHooks";


const ProfileForm = () => {
    
    // const { data, error, handleChange, handleSubmit } = useProfHook();
    const {data, error, submited, handleChange, handleSubmit} = useProfHook();
